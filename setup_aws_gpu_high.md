## Setup Large Scale Machine Learning Development Environment on AWS EC2

### (1) [AWS](https://aws.amazon.com/) EC2 Instance Creation
- Region: Your choice
- Instance: `p5.48xlarge / p5e.48xlarge / p5en.48xlarge / p6-b200.48xlarge / p6-b300.48xlarge`
